...
try{
    ...
    if(isset($s_log)){
        ...
        $login_sql = "select * from staff where username='$sun';";
            ...
            if($password == $p)
                {
                    ...
                    switch ($t) {
                        case 'A':
                            $_SESSION['admin'] = array($sun,$sid);
                            header("Location:AdminDashBoard.php");
                            break;
                        
                        case 'C':
                            $_SESSION['activestaff'] = array($sun,$sid);
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12 d-flex">
                <div class="ee-login">
                    ...
                    <form method='post'>
                        <div class="row">
                            <div class="col-12 mb-30">
                                ...
                                <?php if(isset($err))  if($err == 'invalid username') {?>
                                <span class='ml-10'><?php echo $err; }?></span>
                             </div>
                            

                            <div class="col-12 mb-20">
                                <input type="password" placeholder="Enter your passward" name='ps'>
                                <?php if(isset($err)) if($err == 'invalid password'){ ?>
                                <span class='ml-10'><?php echo $err;} ?>
                            </div>
                            ...
                            <div id='st-login'>
                                <form action="#" method='post'>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-30"><h4>Username</h4><input name='sun' >
                                        <?php if(isset($err1))  if($err1 == 'invalid username') {?>
                                        <span class='ml-10'><?php echo $err; }?></span></div> 
                                        <div class="col-12 mb-30"><h4>Password</h4><input type='password' name='spas' >
                                       <?php if(isset($err1)) if($err1 == 'invalid password'){ ?>
                                        <span class='ml-10'><?php echo $err;} ?>
                                        </div>

                                        <div class="col-12 ml-15"><input  id='sub' type="submit" value="loging" name='s_log'></div>   
                    ...
                    <h4 id='s-login' class='mt-20'>Staff  <a id='lo'>login</a></h4>
