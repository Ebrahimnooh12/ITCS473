...
try{
    ...
    $bestdish_sql = "SELECT pic,type,did,name,offer FROM category c,dish d, offer o WHERE d.fid = o.fid  and d.ct_id = c.qid order by rate,offer limit 2;";
    ...
    $bestdish = $db->query($bestdish_sql);
