...
if(isset($id)){
    ...
    try{
        ...
        $order_sql = "select * from orderdetail, dish WHERE dish.did = orderdetail.did and oid=$id;";
            ...
            <div class="col-12">
                    ...
                    <div class="cart-table table-responsive mb-40">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th class="pro-thumbnail">Dish</th>
                                    <th class="pro-thumbnail">Unite Price</th>
                                    <th class="pro-thumbnail">Quantity</th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                <tr>
                                    <td class="pro-thumbnail"><span><a id="dish" href="single-dish.php?d=<?php echo $row['did']?>"><?php echo $row['name'] ?></a></span></td>
                                    <td class="pro-thumbnail"><span><?php echo $row['price'] ?> BD</span></td>
                                    <td class="pro-thumbnail"><span><?php echo $row['qty'] ?></span></td>
                                </tr>
                            </tbody>
