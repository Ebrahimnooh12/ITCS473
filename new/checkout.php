...
<head>
    ...
    <title>D&D - Food Ordring checkout</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <!-- Checkout Form s-->
             <form action="placeorder.php" method="post" class="checkout-form">
                           ...
                           <div id="billing-form" class="mb-40">
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-md-6 col-12 mb-20">
                                       <label>Enter Address line*</label>
                                       <select class="nice-select" name='add'>
                                           <?php foreach($address as $row) {?>
                                            <option value='<?php echo $row['lid']?>'><?php echo $row['city'].' B.'.$row['building'].' S.'.$row['street'];?></option>
                                           <?php }?> 
                                       </select>
                                   </div>
                           ...
                           <div class="row">
                               ...
                               <div class="col-12 mb-60">
                                   ...
                                   <div class="checkout-cart-total">
                                       ...
                                       <h4>Dishs <span>Total</span></h4><ul>
                                       <?php $total=0; foreach($_SESSION['mycart'] as $k=>$v) {
                                             $name=$v[0];
                                             $price=$v[1];
                                             $q=$v[2];
                                             $p=$v[3];
                                            ...
                                            $total += $price * $q;
                                       ?>
                                           <li><?php echo $name ?><span><?php echo $subt ?> BD</span></li>

                                       <?php } ?> 
                                       </ul>
                                       
                                       <h4>Total <span><?php echo $total ?>BD</span></h4>
                               ...
                               <div class="col-12 mb-60">
                                   ...
                                   <div class="checkout-payment-method">
                                       ...
                                       <div class="single-method">
                                           ...
                                           <label for="payment_paypal">Debit Card</label>
                                       </div>
                                     
                                       <div class="single-method">
                                           <input type="radio" id="payment_payoneer" name="payment_method" value="3">
                                           <label for="payment_payoneer">Credit Card</label>
                                        </div>
                                     <hr>
                                        <div class="single-method ">
