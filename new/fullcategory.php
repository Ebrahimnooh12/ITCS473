            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col order-2 order-lg-12 order-xl-12">
                    ...
                    <div class="header-shop-links">
                        ...
                        <!-- Cart -->
                        <a href="cart.html" class="header-cart"><i class="ti-shopping-cart"></i> <span class="number"><?php echo count($_SESSION['mycart']); ?> </span></a>
...
<div class="mini-cart-wrap">
    ...
    <ul class="mini-cart-products">
        ...
        <div class="mini-cart-bottom">    
            ...
            <h4 class="sub-total">Total: <span>6.800 BD</span></h4>
        ...
        <div class="row">
            ...
            <div class="contact-page-title col mb-40">
                ...
                <ul>
                  ...
                  foreach($rs1 as $row) { $type=$row['type'] ?>             
                  <?php echo"<ol id='catfull'><a href='dish-grid.php?typ=$type'>"?>    
                  <?php echo $row['type'] ?></a></ol>  
                  <?php }?>
                </ul>                
            </div>
        </div>
