...
try{
    ...
    $dishsql = "select * from dish INNER JOIN category ON dish.ct_id = category.qid,offer where offer.fid = dish.fid and did= $id";
                    ...
                    <div class="single-product-description">
                        ...
                        <div class="quantity-colors">
                            ...
                            <div class="quantity">
                                ...
                                <input type="hidden" name="price" value="<?php if($row['fid'] == null){ echo $row['price'];} else echo ($row['price']-($row['price'] * ($row['offer'] / 100 )));?>">
