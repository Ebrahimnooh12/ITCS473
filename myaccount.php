        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12 d-flex">
                <div class="ee-register">    
                    ...
                    <form action="update.php" method='post'>
                        <div class="row">
                            <div class="col-12 mb-30"><h4><b>Username</b></h4><input name='username' value='<?php echo $u;?>'></div>
                            <div class="col-12 mb-30"><h4><b>First Name</b></h4><input name='fname' value='<?php echo $f;?>'></div>                          
                            <div class="col-12 mb-30"><h4><b>Last Name</b></h4><input name='lname' value='<?php echo $l;?>'></div>                            
                            <div class="col-12 mb-30"><h4><b>Email</b></h4><input name='email' value='<?php echo $m;?>'></div>

                            <div class="col-12 mb-30"><h4><b>TEL</b></h4>
                            <?php foreach($ctel as $row) { ?>
                            <input type="hidden" name="telid[]" value='<?php echo $row['cnt_id'];?>'>
                            <input name='tel[]' class='mt-5' value='<?php echo $row['tel'];?>'>
                            <?php }?>
                            </div>
            ...
            <div class="col-md-5 col-12 d-flex">
                ...
                <div class="ee-account-image">                    
                    <img id='img-back' src="assets/images/userpic/<?php echo $uP;?>" alt="Account Image Placeholder" class="image-placeholder">
            ...
            <div class="col-md-6 col-12 d-flex">
                <div class="ee-register">    
                    ...
                    <form action="update.php" method='post'>
                    <div class="row">
                        <div class="col-12 mb-30"><h4><b>Address</b></h4></div>
                            <ol type="I">
                            ...
                            <div class="col-12 mb-30"><h4>
                                <b>Address</b></h4>
                                <a><i id='edit' class="fa fa-pencil fa-lg mr-20 "></i></a> 
                                <a href='update.php?locid=<?php echo $row['lid']; ?>&st=dl' id='delete'><i id='delete' class="fa fa-trash-o fa-lg "></i></a>   
                               <?php if(isset($err))
                                        {   
                                            if($err == 1) {?>
                                                <span id='error' class='ml-10'>You can not be without an address !!, you can edit it for instead</span>
                            ...
                            <div id='edit-loc'>
                                <form action="update.php" method='post'>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-30"><h4>City</h4><input name='c' value='<?php echo $row['city'];?>'></div>
                                        <div class="col-12 mb-30"><h4>Buliding</h4><input name='b' value='<?php echo $row['building'];?>'></div>
                                        <div class="col-12 mb-30"><h4>Streat</h4><input name='s' value='<?php echo $row['street'];?>'></div>
                                        <input type="hidden" name="locid" value='<?php echo $row['lid'];?>'>
                                        <div class="col-12 ml-15"><input  id='sub' type="submit" value="Save" name='loc_u'></div>   
